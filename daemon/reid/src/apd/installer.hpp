...
constexpr const char* kInstallerBanner = R"APATCH( ___         ____       _       _     
|_ _|___ ___|  _ \ __ _| |_ ___| |__  
 | |/ __/ _ \ |_) / _` | __/ __| '_ \ 
 | | (_|  __/  __/ (_| | || (__| | | |
|___\___\___|_|   \__,_|\__\___|_| |_|
)APATCH";

constexpr const char* kInstallerContent = R"APATCH(#!/system/bin/sh
############################################
# IcePatch Module installer script
...
install_module() {
  ...
  if is_legacy_script; then
    ...
    print_title "Powered by IcePatch"
